...
Coefficients of $\color{red}x$ :$$ f(x) = \color{red} x \color{black} \cdot \color{orange} x \cdot x$$

Coefficients of $\color{green}x$ :$$ f(x) = \color{orange} x \color{black} \cdot \color{green} x \color{black} \cdot \color{orange} x$$

Coefficients of $\color{blue} x$: $$ f(x) = \color{orange} x  \cdot  x \color{black}\cdot \color{orange} x$$
